...
Class misthodosia {
    ...
    public function ektiposi(){
        ...
        foreach ($this->raw_data['analysis'] as $income_type => $income) {
            echo '<div style="margin-bottom: 5px; border: 1px solid #ccc; padding: 5px; text-align: left; color: #666; font-style: italic">Τύπος Μισθοδοσίας: '. get_type($income_type) . '</div>';          
            $this->pdf_margin(3);
